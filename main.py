...
ODDS_API_KEY     = os.environ.get("ODDS_API_KEY") or "9a8fdf02aa5ec29ae88765c4c8f78576dcc48e8e96da746fad0b3ac183ad42d5"
_ANTHROPIC_ENV = (os.environ.get("ANTHROPIC_API_KEY") or "").strip()
ANTHROPIC_KEY    = _ANTHROPIC_ENV if len(_ANTHROPIC_ENV) > 20 else "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"
...
LIGAS = {
    ...
    "nations_uefa": {"nombre":"UEFA Nations League",     "sofa_id":338,   "odds_sport":"soccer_uefa_nations_league",       "deporte":"futbol"},
    "concacaf_nl":  {"nombre":"CONCACAF Nations League", "sofa_id":1091,  "odds_sport":"soccer_concacaf_nations_league",   "deporte":"futbol"},
    "copa_america": {"nombre":"Copa America",            "sofa_id":155,   "odds_sport":"soccer_conmebol_copa_america",     "deporte":"futbol"},
    "wc_qual_conc": {"nombre":"Clasif. CONCACAF",        "sofa_id":868,   "odds_sport":"soccer_internation_friendlies",    "deporte":"futbol"},
    "wc_qual_csmb": {"nombre":"Clasif. CONMEBOL",        "sofa_id":325,   "odds_sport":"soccer_internation_friendlies",    "deporte":"futbol"},
