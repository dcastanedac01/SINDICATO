...
ANTHROPIC_KEY    = os.environ.get("ANTHROPIC_API_KEY") or "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"
...
def api_mlb():
    return jsonify([{
        ...
        "rpg_local":p.get("stats_local",{}).get("rpg",4.5),
        "rpg_visita":p.get("stats_visita",{}).get("rpg",4.3),
        "momios":p.get("momios_static",{}),
    } for p in get_mlb_hoy()])
